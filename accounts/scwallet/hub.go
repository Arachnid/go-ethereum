...
//    wallet and client. This requires a secret value called a 'PAIRING_PASSWORD'. You can
//    pair with an unpaired wallet with `personal.openWallet(URI, PAIRING_PASSWORD)`.
